...
export const messages: MessagesCatalog = {
  en: {
    ...
    customerLayout: {
      ...
      secondaryBody: 'Customer access now lives on neutral auth, channel, and account routes with the legacy generic Kap entrypoints removed.',
      trustLines: [
  ...
  zh: {
    ...
    customerLayout: {
      ...
      secondaryBody: '客户访问现在统一使用中立的 auth、channels 与 account 路由，旧的通用 Kap 入口已经删除。',
      trustLines: [
        '全程加密传输',
        '登录、验证与接入保持同一路径',
        '为客户与个人通道统一设计',
