  ...
  en: {
    ...
    homepage: {
      hero: {
        ...
        titleLine3: 'with you.',
        body: 'Kap AI is more than a tool. It becomes a sharper partner as it learns your rhythm, priorities, and context over time.',
        primaryCta: 'Register',
      ...
      contact: {
        eyebrow: 'Start',
        title: 'Create your account, then continue in the same flow.',
        body: 'Register, verify your email, and keep moving into your personal WeChat setup or the global WhatsApp entry.',
  ...
  zh: {
    ...
    homepage: {
      hero: {
        ...
        titleLine3: 'AI 助手。',
        body: 'Kap AI 不只是工具，更会在长期使用中逐渐理解你的节奏、优先级和上下文，成为更懂你的智能伙伴。',
        primaryCta: '注册',
        secondaryCta: '登录',
      ...
      contact: {
        eyebrow: '开始',
        title: '创建账号，然后继续你的下一步。',
        body: '先注册、验证邮箱，再继续进入个人微信设置或全球 WhatsApp 入口。',
        primaryCta: '创建账号',
        secondaryCta: '已有账号',
        placeholder: '你的邮箱',
